...
\begin{table}[t]
\centering
\caption{Performance of the five models trained on the full set of 13 input features. The training time is measured on a compute node of Hercules with four CPU cores and 16\,GB of RAM. The two noisy models use the noise model of the IBM device ibm\_fez.}
